...
### Project idea
Training deep learning model for classification problem of face emotions using pretrained face embeddings from library [face_recogntion]("https://pypi.org/project/face_recognition/"). All details in [paper]("paper.pdf")
