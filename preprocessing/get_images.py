...
def main():
    ...
    data = np.genfromtxt('../../all/fer2013/fer2013.csv',delimiter=',',dtype=None)
    ...
    for i, d in enumerate(dataset):
        usage_path = os.path.join(os.path.abspath(output_path), str(d[-1]))
        label_path = os.path.join(usage_path, str(label_names[d[0]]))
